...
using StarterAssets; // for Unity third person controller
...
public class WunderlandStarterAssetsInputs : MonoBehaviour
{
    // originals
    ...
    // should have called this SelectGun!
    ...
    // should have called this SelectRifle!
